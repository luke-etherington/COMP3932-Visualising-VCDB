...
navbar = dbc.NavbarSimple([
    dbc.NavItem(dbc.NavLink("Incident Location Map", href="incident_location_map", active="exact")),
    dbc.NavItem(dbc.NavLink("Data Loss", href="confidential_data_loss", active="exact")),
